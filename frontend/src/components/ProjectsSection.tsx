...
const ProjectsSection = () => {
  const projects = [
    {
      ...
      description: 'A full-featured online store with product catalog, cart functionality, payment processing, and admin dashboard.',
      tags: ['React', 'Node.js', 'MongoDB'],
      imageUrl: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1400&q=80',
      demoUrl: '#',
      githubUrl: '#'
    },
    {
  ...
  return (
    <section id="projects" className="section-padding bg-gradient-to-b from-background to-secondary/5 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Explore our diverse portfolio of innovative digital solutions across web, mobile, and game development.
          </p>
        </div>
